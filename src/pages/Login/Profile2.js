                  ...
                  <div class="user_welcome">
                    ...
                    <Paper className="particulars-paper">
                      ...
                      {this.state.userDetails != null ? (
                        ...
                        <p>Address: Nothing yet!</p>
                      )}
                      {this.state.userDetails != null ? (
                        <p>ZIP Code: S{this.state.userDetails.zip}</p>
                      ) : (
                        <p>ZIP Code: Nothing yet!</p>
                      )}
                      {this.state.userDetails != null ? (
                        <p>Phone: {this.state.userDetails.phone}</p>
                      ) : (
                        <p>Phone: Nothing yet!</p>
                      )}
                      {this.state.userDetails != null ? (
                        <p>Total points: {this.state.userDetails.points}</p>
                      ) : (
                        <p>Total points: Nothing yet!</p>
                      )}
                    </Paper>
                    <Button
                      variant="contained"
